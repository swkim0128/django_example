...
from imagekit.models import ProcessedImageField # imagekit에서 이미지를 처리하는 필드를 import
from imagekit.processors import ResizeToFill # imagekit에서 이미지 사이즈를 재조정하는 기능을 import
